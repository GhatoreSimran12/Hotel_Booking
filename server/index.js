...
async function main() {
  ...
  await mongoose.connect("mongodb+srv://simranghatore167:MPHSAS5FUiJbgKIy@cluster0.sl7ymd0.mongodb.net")
...
const transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: "simranghatore167@gmail.com",
...
app.post("/book/room", async (req, res) => {
  try {
    ...
    if (availability) {
      const maileOptions = {
        from: "simranghatore167@gmail.com",
        to: email,
      ...
      Thank you for choosing Hotel Del Luna for your upcoming stay. We can't wait to provide 
